...
public class MonsterStatusConst {
    ...
    public const string BossSlimeName = "BossSlime";
    public const string BossHealerName = "BossHealer";
    ...
    public const string BossSlimeTag = "BossSlime";
    public const string BossHealerTag = "BossHealer";
	...
	// 種類ごとの各モンスター名リスト
	// ※モンスターを増やすごとに追加
	static readonly List<string> fighterMonsterNameList = new List<string> { SlimeName, SlimeRedName, OrgeOrangeName, OrgeGreenName, ChimeraRedName, ChimeraPurpleName, CarbuncleName, ZonbieWhiteName, ZonbieGreenName, BossSlimeName };
	...
	static readonly List<string> simpleHealerMonsterNameList = new List<string> { FairyYellowName, FairyPurpleName, UnicornWhiteName, UnicornBlackName, BossHealerName };
	...
	readonly Dictionary<string, Dictionary<string, float>> monsterStatusMap
        ...
        { BossSlimeTag, bossSlimeStatusMap },
        { BossHealerTag, bossHealerStatusMap },
    };
