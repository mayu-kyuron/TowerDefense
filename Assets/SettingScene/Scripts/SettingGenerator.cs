...
public class SettingGenerator : MonoBehaviour {
    ...
    void Start () {
        ...
        bgmTextInstance.transform.position = new Vector3(-226, 55, 0);
        ...
        seTextInstance.transform.position = new Vector3(-226, -80, 0);
    ...
    private void SetFirstSettings() {
		...
		Camera.main.GetComponents<AudioSource>()[1].volume = 0.6f;
	}
    ...
    private void DisplayBgmSelection() {
        ...
        soundBtn1Instance.transform.position = new Vector3(-50, 37, 0);
        ...
        soundBtn2Instance.transform.position = new Vector3(50, 37, 0);
        ...
        soundBtn3Instance.transform.position = new Vector3(150, 37, 0);
        ...
        soundBtn4Instance.transform.position = new Vector3(250, 37, 0);
        ...
        soundBtn5Instance.transform.position = new Vector3(350, 37, 0);
    ...
    private void DisplaySeSelection() {
        ...
        seBtn1Instance.transform.position = new Vector3(-50, -95, 0);
        ...
        seBtn2Instance.transform.position = new Vector3(50, -95, 0);
        ...
        seBtn3Instance.transform.position = new Vector3(150, -95, 0);
        ...
        seBtn4Instance.transform.position = new Vector3(250, -95, 0);
        ...
        seBtn5Instance.transform.position = new Vector3(350, -95, 0);
