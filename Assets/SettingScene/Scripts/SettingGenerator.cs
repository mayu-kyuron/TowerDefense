...
public class SettingGenerator : MonoBehaviour {
    ...
    void Start () {
        ...
        bgmTextInstance.transform.position = new Vector3(-380, 170, 0);
        ...
        seTextInstance.transform.position = new Vector3(-395, 70, 0);
        ...
        effectTextInstance.transform.position = new Vector3(-405, -30, 0);
        ...
        damageTextInstance.transform.position = new Vector3(-405, -130, 0);
    ...
    private void DisplayBgmSelection()
    {
        ...
        soundBtn1Instance.transform.position = new Vector3(-170, 150, 0);
        ...
        soundBtn2Instance.transform.position = new Vector3(-20, 150, 0);
        ...
        soundBtn3Instance.transform.position = new Vector3(130, 150, 0);
        ...
        soundBtn4Instance.transform.position = new Vector3(280, 150, 0);
        ...
        soundBtn5Instance.transform.position = new Vector3(430, 150, 0);
    ...
    private void DisplaySeSelection()
    {
        ...
        seBtn1Instance.transform.position = new Vector3(-170, 50, 0);
        ...
        seBtn2Instance.transform.position = new Vector3(-20, 50, 0);
        ...
        seBtn3Instance.transform.position = new Vector3(130, 50, 0);
        ...
        seBtn4Instance.transform.position = new Vector3(280, 50, 0);
        ...
        seBtn5Instance.transform.position = new Vector3(430, 50, 0);
    ...
    private void DisplayEffectSelection()
    {
        ...
        effectBtn1Instance.transform.position = new Vector3(-170, -50, 0);
        ...
        effectBtn2Instance.transform.position = new Vector3(30, -50, 0);
    ...
    private void DisplayDamageSelection()
    {
        ...
        damageBtn1Instance.transform.position = new Vector3(-170, -150, 0);
        ...
        damageBtn2Instance.transform.position = new Vector3(30, -150, 0);
