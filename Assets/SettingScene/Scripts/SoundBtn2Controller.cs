...
public class SoundBtn2Controller : MonoBehaviour {
    ...
    void Start () {
            ...
            && (object)GlobalObject.getInstance().Params[1] != null)
        {
            ...
            if (settingObjectFromOthers.BgmNum == 2)
            {
                toggle.isOn = true;
            }
        }
    ...
    public void OnValueChanged(bool value)
    {
        if (value)
        {
            ...
            Camera.main.GetComponents<AudioSource>()[0].volume = 0.4f;
            settingObject.GetComponent<SettingObject>().SetBgmNum(2);
        }
    }
}
