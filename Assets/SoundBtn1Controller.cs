...
public class SoundBtn1Controller : MonoBehaviour {
    ...
    void Start () {
            ...
            && (object)GlobalObject.getInstance().Params[1] != null)
        {
            ...
            if (settingObjectFromOthers.BgmNum == 1)
            {
                toggle.isOn = true;
            }
        }
    ...
    public void OnValueChanged(bool value)
    {
        if (value)
        {
            ...
            Camera.main.GetComponents<AudioSource>()[0].volume = 0.2f;
            settingObject.GetComponent<SettingObject>().SetBgmNum(1);
        }
    }
}
